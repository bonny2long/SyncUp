...
const TeamInsights = ({ data, projectId }) => {
  const insights = useMemo(() => {
    ...
    if (data.momentum && data.momentum.length > 1) {
      ...
      const growthRate =
        previousWeek.signals > 0 ?
          ((recentWeek.signals - previousWeek.signals) / previousWeek.signals) *
          100
        : 0;
      ...
      if (growthRate > 30) {
        generatedInsights.push({
          ...
          recommendation:
            "Keep up the momentum. Consider documenting best practices.",
          priority: "high",
        });
        ...
        generatedInsights.push({
          ...
          recommendation:
            "Continue current collaboration patterns and skill development.",
          priority: "medium",
        });
      } else if (growthRate < -10) {
        generatedInsights.push({
          ...
          recommendation:
            "Check team workload and remove any blockers to progress.",
          priority: "high",
        });
      }
    }
    ...
    if (data.skillDistribution && data.skillDistribution.length > 0) {
      ...
      if (skillsPerMember < 2) {
        generatedInsights.push({
          ...
          recommendation:
            "Encourage team members to explore new technologies and share knowledge.",
          priority: "medium",
        });
      }
    }
    ...
    if (data.overview) {
      const activeRate =
        data.overview.active_this_week / data.overview.team_size;
      ...
      if (activeRate > 0.8) {
        generatedInsights.push({
          ...
          recommendation:
            "Excellent engagement! Consider recognizing active contributors.",
          priority: "low",
        });
        ...
        generatedInsights.push({
          ...
          recommendation:
            "Check in with team members and identify any obstacles to progress.",
          priority: "high",
        });
      }
    }
    ...
    if (data.individualComparison && data.individualComparison.length > 0) {
      const avgWeight =
        data.individualComparison.reduce(
          (sum, member) => sum + member.user_weight,
          0,
        ) / data.individualComparison.length;
      ...
      if (topPerformer.user_weight > avgWeight * 2) {
        generatedInsights.push({
          ...
          recommendation:
            "Consider leadership opportunities and knowledge sharing sessions.",
          priority: "medium",
        });
      }
    }
    ...
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">
          AI-powered insights will appear here once there's enough team activity
          data.
        </p>
      </div>
    );
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 h-full flex flex-col">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Actionable recommendations based on team performance and activity
          patterns
        </p>
      </div>
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span
                    className={`px-2 py-0.5 rounded text-xs font-medium ${getPriorityBadge(insight.priority)} uppercase tracking-wider`}
                  >
                ...
                <div className="bg-white bg-opacity-60 rounded p-3">
                  <p className="text-xs font-medium text-gray-600 mb-1 flex items-center">
                    <Lightbulb className="w-3 h-3 mr-1" /> Recommendation:
                  </p>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <p className="text-sm text-blue-700">
          These insights are generated based on your team's activity patterns,
          skill growth trends, and performance metrics. They update
          automatically as your team generates more signals and engages in
          projects.
        </p>
      </div>
    </div>
